...
local function run(msg, matches)
  if matches[1]:lower() == 'plusbot' then -- Put everything you like :)
  ...
  if matches[1]:lower() == "stats" then
    ...
    if matches[2] == "plusbot" then -- Put everything you like :)
...
return {
  patterns = {
    ...
    "^[!/]([Ss]tatslist)$",
    "^[!/]([Ss]tats) (group) (%d+)",
    "^[!/]([Ss]tats) (plusbot)",-- Put everything you like :)
		"^[!/]([Pp]lusbot)"-- Put everything you like :)
    }, 
  run = run
}
